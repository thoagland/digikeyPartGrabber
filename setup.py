...
setup(
        ...
        packages=['venv.Lib.site-packages.bs4', 'venv.Lib.site-packages.bs4.tests',
                  ...
                  'venv.Lib.site-packages.chardet', 'venv.Lib.site-packages.chardet.cli',
                  ...
                  'venv.Lib.site-packages.soupsieve', 'venv.Lib.site-packages.pip-10.0.1-py3.7.egg.pip',
                  ...
                  'venv.Lib.site-packages.pip-10.0.1-py3.7.egg.pip._internal.operations', 'digikeyPartGrabber'],
        url='https://github.com/thoagland/digikeyPartGrabber',
        license='GPL-3.0',
        author='Tim Hoagland',
        author_email='timhoagland@gmail.com',
        description='Parse select data values for a given Digikey part number'
)
